...
import { LinkIcon, LogOutIcon, CheckCircle2Icon } from 'lucide-react';
...
export const ProfileAvatar = forwardRef<HTMLDivElement, ProfileAvatarProps>(
  (
    ...
    const { user, authenticated, logout, linkFarcaster, linkTwitter } =
      usePrivy();
      ...
      <div ref={ref} className={`flex items-center gap-3 ${className}`}>
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56" align="end">
            ...
            {!twitterAccount && (
              <DropdownMenuItem onClick={handleLinkTwitter}>
                <LinkIcon />
                <XIcon />
                <span>Link X</span>
              </DropdownMenuItem>
